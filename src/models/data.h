...
const Card CARDS_DATA[CARDS_NUMBER] = {
    ...
    {"C016", "Minieuro", "Era X",      "Blue",     "c016.jpg", "As long as this card is on your playerboard, when you Deploy a Fortification, you may depoy it in any Zone (also in zones where you are not)."},
    {"C017", "Minieuro", "Era X",      "Blue",     "c017.jpg", "As long as this card is on your playerboard, when you Recruit 1 Minion, you may gain 1 Experience Point."},
    ...
    {"C019", "Minieuro", "Era X",      "Blue",     "c019.jpg", "As long as this card is on your playerboard, add 2 to the Strengh of your Hero."},
    {"C020", "Minieuro", "Era X",      "Blue",     "c020.jpg", "As long as this card is on your playerboard, when you play a Development Card, you may not pay its placing cost."},
    ...
    {"C038", "Minieuro", "Era I",      "Blue",     "c038.jpg", "As long as this card is on your playerboard, when you Move your Hero, you may carry 1 any unit. The carried unit have to be in the same Zone of your Hero. (You can not carry a unit that has already moved this turn. If you move the Hero several times, you can move a different unit each time.)"},
    {"C039", "Minieuro", "Era I",      "Blue",     "c039.jpg", "As long as this card is on your playerboard, when you Recruit 1 Minion, you may Deploy it without cost."},
    {"C040", "Minieuro", "Era I",      "Blue",     "c040.jpg", "As long as this card is on your playerboard, when you play a Gadget Card, you may not pay its placing cost."},
    ...
    {"C056", "Minieuro", "Era II",     "Blue",     "c056.jpg", "As long as this card is on your playerboard, when you Deploy 1 unit, you may Deploy it in any Zone of the Island where your Hero is."},
    {"C057", "Minieuro", "Era II",     "Blue",     "c057.jpg", "As long as this card is on your playerboard, when you play a Tactic Card, you may not pay its Energy cost."},
    {"C058", "Minieuro", "Era II",     "Blue",     "c058.jpg", "As long as this card is on your playerboard, add 1 to the Strengh of your Golems."},
    {"C059", "Minieuro", "Era II",     "Blue",     "c059.jpg", "As long as this card is on your playerboard, when you Move 1 your Minion, you may carry 1 any unit. The carried unit have to be in the same Zone of your Minion. (You can not carry a unit that has already moved this turn.)"},
    ...
    {"C076", "Minieuro", "Era III",    "Blue",     "c076.jpg", "As long as this card is on your playerboard, add 3 to the Strengh of your Hero."},
    {"C077", "Minieuro", "Era III",    "Blue",     "c077.jpg", "As long as this card is on your playerboard, when you Move 1 your Golem, you may carry 1 any unit. The carried unit have to be in the same Zone of your Golem. (You can not carry a unit that has already moved this turn.)"},
    {"C078", "Minieuro", "Era III",    "Blue",     "c078.jpg", "As long as this card is on your playerboard, when you play a Objective Card, you may not pay its Energy cost."},
    ...
    {"C080", "Minieuro", "Era III",    "Blue",     "c080.jpg", "As long as this card is on your playerboard, add 1 to the Strengh of your Minions."},
